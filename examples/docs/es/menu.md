...
| text-color        | color de texto del menú (formato hexadecimal) | string  | —                     | #1D2129     |
| active-text-color | color del texto del menu-item activo (formato hexadecimal) | string  | —                     | #4886FF     |
