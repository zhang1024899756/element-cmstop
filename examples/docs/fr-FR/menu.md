...
| text-color  | Couleur du texte du menu (format hexadécimal) | string |   —   | #1D2129 |
| active-text-color  | Couleur du texte de l'item actif (format hexadécimal). | string |   —   | #4886FF |
