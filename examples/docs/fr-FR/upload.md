...
accept | [Types de fichiers](https://developer.mozilla.org/en-US/docs/Web/HTML/Cmstop/input#attr-accept) acceptés, ne marche pas si `thumbnail-mode` est `true`. | string | — | —
