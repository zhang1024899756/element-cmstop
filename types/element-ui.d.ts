...
/** The version of cmstop-ui */
export const version: string

/**
 * Install all cmstop-ui components into Vue.
 * Please do not invoke this method directly.
 * Call `Vue.use(CmstopUI)` to install.
 */
export function install (vue: typeof Vue, options: InstallationOptions): void

/** CmstopUI component common definition */
export type Component = CmstopUIComponent

/** Component size definition for button, input, etc */
export type ComponentSize = CmstopUIComponentSize

/** Horizontal alignment */
export type HorizontalAlignment = CmstopUIHorizontalAlignment
